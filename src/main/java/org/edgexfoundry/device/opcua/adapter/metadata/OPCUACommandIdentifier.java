...
public enum OPCUACommandIdentifier {
  WELLKNOWN_COMMAND(10, "wellknown_command"), ATTRIBUTE_COMMAND(11,
      "attribute_command"), METHOD_COMMAND(12, "method_command"), WELLKNOWN_COMMAND_GROUP(20,
          "wellknown~groupcommand"), WELLKNOWN_COMMAND_START(21,
              "wellknown~startcommand"), WELLKNOWN_COMMAND_STOP(22,
                  "wellknown~stopcommand"), WELLKNOWN_COMMAND_GETENDPOINT(23,
                      "wellknown~getendpointcommand");
