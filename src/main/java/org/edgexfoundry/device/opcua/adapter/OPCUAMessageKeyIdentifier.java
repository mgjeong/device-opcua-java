...
public enum OPCUAMessageKeyIdentifier {
  ...
  SECURITYPOLICY_URI(7, "security_policy_uri", "security policy uri for server"),
  ENDPOINT_URI(8, "endpoint_uri", "endpoint uri for server"), 
  ENDPOINT_INFOMATION(9, "endpoint_information", "endpoint infomation for server"), 
  RESPONSE_INFO(10,"response_information", "response infomation");
