...
import org.edgexfoundry.samsung.opcua.handler.CoreDataMessageHandler;
...
public class ObjectStore {
    ...
    public void put(Device device, ResourceOperation operation, String value) {
        ...
        String operationId = objectsList.stream().map(o -> o.getName()).collect(Collectors.toList())
                .toString();
    ...
    private List<OPCUAObject> createObjectsList(ResourceOperation operation, Device device) {
        ...
        if (operation != null && objects != null) {
            ...
            /*
             * Delete Check ValueDescriptor Exist and Get(and Create)
             * ValueDescriptor Using operation.parameter Because OPCUAObject
             * name is changed operation.parameter, This is Dangerous
             */
