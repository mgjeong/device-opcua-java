...
cd $DEP_ROOT
git clone https://github.com/mgjeong/protocol-ezmq-java.git
...
cd $DEP_ROOT
git clone https://github.com/mgjeong/protocol-opcua-java.git
...
cd $DEP_ROOT
git clone https://github.com/mgjeong/datamodel-command-java.git
