...
git clone -b $release_tag git@github.sec.samsung.net:RS7-EdgeComputing/protocol-opcua-java.git
...
git clone -b $release_tag git@github.sec.samsung.net:RS7-EdgeComputing/datamodel-command-java.git
