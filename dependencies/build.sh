...
git clone -b 1.0_rel git@github.sec.samsung.net:RS7-EdgeComputing/protocol-opcua-java.git
...
git clone -b 1.0_rel git@github.sec.samsung.net:RS7-EdgeComputing/datamodel-command-java.git
