...
public class EdgeTestMethodVersion {
  private final Logger logger = LoggerFactory.getLogger(getClass());

  @UaMethod
  public void invoke(InvocationContext context, @UaOutputArgument(name = "version",
      description = "The positive square root of x. If the argument is NaN or less than zero, the result is NaN.") Out<String> Version) {

    logger.debug("Invoking print() method of Object '{}'",
        context.getObjectNode().getBrowseName().getName());

    Version.set("09131759");
  }
}
